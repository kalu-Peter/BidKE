...
/**
 * Test the auctions.php endpoint for cars category
 */

$base_url = 'http://localhost:8000';
$test_url = $base_url . '/auctions.php?category=cars&status=live&limit=5';

echo "Testing Cars API endpoint...\n";
echo "URL: $test_url\n\n";
