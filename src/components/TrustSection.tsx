...
const trustFeatures = [
  {
    ...
    description:
      "All businesses go through strict verification including business registration and financial checks",
    icon: CheckCircle,
  ...
  },
  {
    ...
    description:
      "See all bid history and compete fairly with real-time updates",
    icon: Eye,
  ...
  },
  {
    ...
    description:
      "SSL encryption, secure payments, and data protection compliance",
    icon: Shield,
    color: "text-primary",
  },
  {
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {trustFeatures.map((feature, index) => (
            <Card
              key={index}
              className="border-0 shadow-card hover:shadow-elegant transition-all duration-300"
            >
