...
const Footer = () => {
  ...
  return (
    <>
      ...
      <footer className="bg-gradient-to-b from-background via-[#001449] to-[#00072D] text-primary-foreground">
        <div className="container mx-auto px-4 py-16">
          <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-8">
            ...
            <div>
              ...
              <p className="text-primary-foreground/80 mb-6">
                Kenya's premier platform for repossession auctions. Connecting
                verified businesses with serious buyers.
              </p>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-sm text-primary-foreground/60 mb-4 md:mb-0">
              © 2025 BidLode. All rights reserved. | Kenya's Premier Auction
              Platform
            </div>
