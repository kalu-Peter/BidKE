...
const steps = [
  {
    ...
    description:
      "Create your account and complete our verification process for secure bidding",
    icon: UserCheck,
    type: "buyer",
  },
  {
    ...
    title: "Browse & Search",
    description:
      "Explore categories and find the items you're interested in bidding on",
    icon: Search,
    type: "buyer",
  },
  {
    ...
    description:
      "Bid confidently with our transparent, real-time auction system",
    icon: Gavel,
    type: "buyer",
  },
  {
    ...
    description:
      "Pay safely through our escrow system with M-Pesa or bank transfer",
    icon: CreditCard,
    type: "buyer",
  },
  {
    ...
    <section className="py-20 bg-secondary/30">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <Badge
            variant="outline"
            className="mb-4 text-muted-foreground border-muted-foreground"
          >
            Simple Process
          </Badge>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-6">
          {steps.map((step, index) => (
            <Card
              key={index}
              className="relative border-0 shadow-card group hover:shadow-elegant transition-all duration-300"
            >
        ...
        <div className="mt-16 text-center">
          <div className="bg-card rounded-2xl p-8 max-w-4xl mx-auto shadow-card">
            ...
            <p className="text-muted-foreground mb-6">
              List your repossessed items, reach verified buyers, and maximize
              recovery rates through our transparent auction platform.
            </p>
