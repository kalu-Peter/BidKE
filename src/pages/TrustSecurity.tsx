  ...
  const securityFeatures = [
    {
      ...
      description:
        "All data transmission is protected with military-grade encryption to keep your information secure.",
      color: "bg-blue-500",
    },
    {
      icon: UserCheck,
      ...
      description:
        "Every user completes identity verification ensuring a trusted community of buyers and sellers.",
      color: "bg-green-500",
    },
    {
      icon: CreditCard,
      ...
      description:
        "PCI-compliant payment processing with escrow protection for all transactions.",
      color: "bg-purple-500",
    },
    {
      icon: Eye,
      ...
      description:
        "Open bidding history, seller ratings, and detailed item descriptions for informed decisions.",
      color: "bg-orange-500",
    },
    {
      icon: Lock,
      ...
      description:
        "GDPR-compliant data handling with strict privacy controls and regular security audits.",
      color: "bg-red-500",
    },
    {
      icon: FileText,
      ...
      description:
        "Fully licensed and compliant with Kenyan financial regulations and auction laws.",
      color: "bg-indigo-500",
    },
  ];
  ...
  const reportingOptions = [
    {
      ...
      description:
        "Immediately report any fraudulent listings or suspicious user behavior",
      action: "Report Now",
    },
    {
      icon: FileText,
